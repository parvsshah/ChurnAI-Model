    ...
    (
        {
            ...
            description = "Sed ut perspiciatis unde omnis iste natus voluptatem.",
            ctaText = "Get Started",
            ctaHref = "#",
            bottomImage,
            gridOptions,
                ...
                <section className="relative max-w-full mx-auto z-1">
                    ...
                    <div className="max-w-screen-xl z-10 mx-auto px-4 py-28 gap-12 md:px-8">
                        <div className="space-y-5 max-w-3xl leading-0 lg:leading-5 mx-auto text-center">
                            ...
                            <h2 className="text-4xl tracking-tighter font-sans bg-clip-text text-transparent mx-auto md:text-6xl bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)]">
                                {subtitle.regular}
                            ...
                            <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
                                <span className="relative inline-block overflow-hidden rounded-full p-[1.5px]">
                                    ...
                                    <div className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-gray-950 text-xs font-medium backdrop-blur-3xl">
                                        <a
                                            href={ctaHref}
                                            className="inline-flex rounded-full text-center group items-center w-full justify-center bg-gradient-to-tr from-zinc-300/5 via-purple-400/20 to-transparent text-white border-input border-[1px] hover:from-zinc-300/10 hover:via-purple-400/30 transition-all sm:w-auto py-4 px-10"
                                        >
                                            {ctaText}
                                        </a>
                                    </div>
